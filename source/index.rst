...
.. thumbnail:: images/screenshots/ag-welcome.png
   :title: Summary including all alerts generated by the Ubuntu (003) agent during the last hour.
   :class: d-block w-100
...
.. thumbnail:: images/screenshots/discover.png
   :title: Interactive screen showing all events that occurred within the last 7 days.
   :class: d-block w-100
...
.. thumbnail:: images/screenshots/mg-ruleset.png
   :title: Section for the management of the ruleset, decoders and CDB lists, including custom files.
   :class: d-block w-100
...
.. thumbnail:: images/screenshots/ow-fim.png
   :title: Summary graphs showing the file integrity related alerts that occurred in the whole system during the last 30 days.
   :class: d-block w-100
...
.. thumbnail:: images/screenshots/ow-general.png
   :title: Visual summary with all alerts generated in the whole system within the last 24 hours.
   :class: d-block w-100
...
.. thumbnail:: images/screenshots/ow-welcome.png
   :title: Welcome section showing a summary of the total amount of agents in the system and shortcut access to the alert dashboard of every available module.
   :class: d-block w-100
